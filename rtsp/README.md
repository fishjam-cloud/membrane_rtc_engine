# Membrane RTC Engine RTSP Endpoint
...
RTSP Endpoint for the [Membrane RTC Engine](https://github.com/fishjam-cloud/membrane_rtc_engine)
...
def deps do
  [
    {:membrane_rtc_engine_rtsp, "~> 0.10.0"}
  ]
end
```
